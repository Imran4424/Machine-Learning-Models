...
The best thing about Support Vector Machine is it always consider worst case scenario, thus the support vectors. By considering worst case scenario, it perfroms well even with small size datasets.
