...
Prediction Residual Sum of Squares (PRESS) is a cross-validation technique used in regression to measure how well a model can predict a new data which is not used in its training.